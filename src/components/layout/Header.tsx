                                    ...
                                    {categories.length > 0 ? (
                                        categories.slice(0, 5).map((category) => (
                                            <Link
                                                ...
                                                className="px-4 py-2 hover:bg-surface-container-low text-sm text-on-surface transition-colors"
                                            >
                                                {category.name}
                                            </Link>
                                        ))
                                    ) : (
                                        <span className="px-4 py-2 text-xs text-outline font-medium">No categories</span>
                                    )}
                                </div>
                            </div>
                            ...
                            {categories.length > 0 ? (
                                categories.slice(0, 5).map((category) => (
                                    <Link
                                        key={category.id}
                                        href={`/search/category/${category.slug}` as any}
                                        className="py-2 text-on-surface hover:text-primary transition-colors text-sm font-medium"
                                ...
                                <span className="text-xs text-outline font-medium">No categories</span>
                            )}
                        </div>
